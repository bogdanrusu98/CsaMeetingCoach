    ...
    private static IEnumerable<EducationalConcept> ExtendedConcepts()
    {
        return new EducationalConcept[]
        {
            ...
            new(
                ...
                "Session consistency is the default and covers most use cases; strong consistency provides linearizability but increases write latency and is unavailable with multi-region write configurations.",
                ConceptCategory.StorageDatabases,
                true,
            ...
            new(
                ...
                "Unlike message queues, Event Grid is optimized for reactive notification patterns and does not retain events for long-term replay the way Event Hubs partitions do.",
                ConceptCategory.DataAiIntegration,
                true,
            ...
            new(
                ...
                "Unlike AVD shared host pools, each user gets a dedicated persistent Cloud PC, which simplifies license cost prediction but removes multi-session density optimization.",
                ConceptCategory.ComputeContainersAppPlatforms,
                false,
            ...
            new(
                ...
                "Service Endpoints route traffic privately but the service still accepts connections at a public IP; Private Link assigns a private IP inside the VNet, which is a meaningful security distinction.",
                ConceptCategory.Networking,
                true,
            ...
            new(
                ...
                "External ID separates customer and partner identities from the employee directory, which affects token audiences, app registrations, and tenant architecture design.",
                ConceptCategory.IdentitySecurity,
                true,
            ...
            new(
                ...
                "Microsoft Entra ID Governance automates identity lifecycle, access reviews, and entitlement workflows so organizations can manage who holds access to which resources over time.",
            ...
            new(
                ...
                "EASM maps externally visible hosts, domains, certificates, and services including those not intentionally registered, which helps surface shadow assets and expired certificate risks.",
                ConceptCategory.IdentitySecurity,
                true,
            ...
            new(
                ...
                "Defender for IoT uses passive network monitoring that avoids sending packets to devices, which is critical in manufacturing and critical infrastructure where active scanning could disrupt operations.",
                ConceptCategory.IdentitySecurity,
                true,
            ...
            new(
                ...
                "Stacks track resource membership and can apply deny assignments to managed resources, which reduces the risk of orphaned resources or configuration drift caused by changes outside the stack.",
                ConceptCategory.ManagementGovernance,
                true,
            ...
            new(
                ...
                "Experiments target specific resource types with defined fault actions, so teams can quantify blast radius and validate incident runbooks before actual outages occur.",
                ConceptCategory.MonitoringReliability,
                true,
            ...
            new(
                ...
                "Workbooks help visualize correlated data across multiple Azure services, but they rely on query authorship and data source connections that teams must maintain over time.",
                ConceptCategory.MonitoringReliability,
                true,
            ...
            new(
                ...
                "AMA uses Data Collection Rules to define what data is collected, where it is sent, and with what transformations, enabling granular multi-workspace routing without reinstalling agents.",
                ConceptCategory.MonitoringReliability,
                true,

    ...
    private static IEnumerable<EducationalConcept> CoreConcepts()
    {
        return new List<EducationalConcept>
        {
            ...
            new(
                ...
                "Azure Policy evaluates resources against rules so organizations can audit, deny, or modify noncompliant configurations.",
            ...
            new(
                ...
                "Budget alerts do not stop usage by themselves; they surface spend signals so teams can investigate or adjust controls.",
                ConceptCategory.ManagementGovernance,
                true,
            ...
            new(
                ...
                "It fits continuous-event pipelines, where lateness handling and output destinations shape end-to-end behavior.",
                ConceptCategory.DataAiIntegration,
                true,
            ...
            new(
                ...
                "Policies can rewrite, throttle, or validate API traffic, which makes the gateway useful beyond simple exposure.",
                ConceptCategory.DataAiIntegration,
                true,
            ...
            new(
                ...
                "Workflow fit often depends on connector support, retry behavior, and how much process state must be preserved.",
                ConceptCategory.DataAiIntegration,
                false,
                "https://learn.microsoft.com/azure/logic-apps/logic-apps-overview"),
            new(
            ...
            new(
                ...
                "It helps structure transformation work into phases, which is useful when technical choices depend on organizational readiness.",
                ConceptCategory.MigrationDevOpsFinOps,
                true,
